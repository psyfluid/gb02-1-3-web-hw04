...
$workExperience = [
  [
    ...
    'dates' => 'Jan 2015 - <span class="w3-tag w3-teal w3-round">Current</span>',
    'description' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur
  ...
  [
    ...
    'description' => 'Consectetur adipisicing elit. Praesentium magnam
    consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla
          ...
          <div class="w3-container">
            ...
            foreach ($skills as $skill) { ?>
              ...
              <div class="w3-light-grey w3-round-xlarge w3-small">
                <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill['level'] ?>%">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php foreach ($workExperience as $work) { ?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?php echo $work['work'] ?></b></h5>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work['dates'] ?></h6>
